...
# optimize!
# optimizer = torch.optim.AdamW(model.parameters(), lr=6e-4, betas=(0.9, 0.95), eps=1e-8)  # like gpt3
...
for step in range(max_steps):
    ...
    print(f"step {step:4d} | loss: {loss_accum.item():.6f} | lr: {lr:.4e} norm: {norm:.4f} | dt: {dt:.2f}s | tok/sec: {tokens_per_second:.2f}")
