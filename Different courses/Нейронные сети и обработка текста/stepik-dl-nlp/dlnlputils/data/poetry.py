...
class LanguageModelDataset(Dataset):
    def __init__(self, token_ids, chunk_length=100, pad_value=0, dtype=np.int64):
    ...
    def __getitem__(self, item):
        ...
        seed_part = np.array(seed_part, self.dtype)
        target_part = np.array(target_part, self.dtype)
